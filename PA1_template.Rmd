...
After imputing the missing step values, the mean total number of steps per day remained unchanged while the median total number of steps per day changed from r format(median.steps.per.day, scientific=F) to r format(imputed.median.steps.per.day, scientific=F). The impact of the imputation was a slight increase in the median total number of steps per day.
